...
parser.add_argument('--algo', type=int, choices=[1,2], default=2, help="Reconstruction algorithm [Poisson (1) / MarchingCubes (2)]")
...
def main(args):
    ...
    if not os.path.exists(model_path):
        ...
        subprocess.call([command, model_path, os.path.join(h, t.split('.')[0] + '_output.vtk')])
