...
def scaleVal(ival,sense) :
    ...
    if sense == 0 :
        maxIntensity = 4096
    return min(255,int((ival-minIntensity)*256/maxIntensity))
        ...
        if receiveControl == 1 :
            ...
            if waiting >= 130 :
                ...
                if rawQueue[endByte-129] == 1 :
                    ...
                    update = 1
                    #print("Received packet : ",dataQueue)
                    #print("Processed packet : ",dataQueue)
...
class Main(QMainWindow,Ui_MainWindow) :
    ...
    def init(self) :
        ...
        #self.displayHigh1.setAspectLocked(False)
